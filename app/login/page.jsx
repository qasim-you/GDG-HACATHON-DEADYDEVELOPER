...
export default function Login() {
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        if (userData.role === activeTab) {
          ...
          await auth.signOut()
          setError(`This account is not registered as a ${activeTab}. Please use the correct login tab.`)
        }
      } else {
  ...
  const handleGoogleSignIn = async () => {
    if (activeTab !== "patient") {
      setError("Google sign-in is only available for patients")
      return
    }
    ...
    try {
      ...
      if (userDoc.exists()) {
        ...
        if (userData.role === "patient") {
          ...
          await auth.signOut()
          setError("This Google account is not registered as a patient")
        }
      } else {
        ...
        <CardFooter className="flex justify-center">
          <p className="text-sm text-gray-600">
            ...
            {activeTab === "patient" ? (
              ...
              <Link href="/doctor/register" className="text-emerald-600 hover:text-emerald-800 font-medium">
                Register as Doctor
              </Link>
            )}
          </p>
